...
def create_model():
    ...
    check(asparagine.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(glutamate.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(glutamine.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(histidine.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(leucine.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(lysine.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(threonine.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(tyrosine.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(valine.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(ala_trna.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(ala_trna_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(arg_trna.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(arg_trna_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(arg_trna2.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(arg_trna2_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(arg_trna3.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(arg_trna3_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(arg_trna4.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(arg_trna4_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(asn_trna.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(asn_trna_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(asp_trna.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(asp_trna_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(cys_trna.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(cys_trna_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(gln_trna.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(gln_trna_glu_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(gln_trna_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(glu_trna.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(glu_trna_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(gly_trna.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(gly_trna_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(gly_trna2.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(gly_trna2_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(his_trna.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(his_trna_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(ile_trna.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(ile_trna_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(ile_trna2.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(ile_trna2_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(leu_trna.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(leu_trna_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(leu_trna2.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(leu_trna2_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(leu_trna3.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(leu_trna3_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(leu_trna4.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(leu_trna4_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(lys_trna.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(lys_trna_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(lys_trna2.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(lys_trna2_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(met_trna.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(met_trna_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(fmet_trna.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(fmet_trna_metloaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(fmet_trna_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(phe_trna.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(phe_trna_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(pro_trna.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(pro_trna_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(ser_trna.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(ser_trna_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(ser_trna2.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(ser_trna2_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(ser_trna3.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(ser_trna3_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(ser_trna4.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(ser_trna4_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(thr_trna.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(thr_trna_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(thr_trna2.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(thr_trna2_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(thr_trna3.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(thr_trna3_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(trp_trna.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(trp_trna_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(trp_trna2.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(trp_trna2_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(tyr_trna_loaded.setId('aminoacylated_MG504'),    'set species s1 id')
    ...
    check(tyr_trna_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(val_trna.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(val_trna_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(tmrna.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(tmrna_loaded.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(ala_trna_ligase.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(arg_trna_ligase.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(asn_trna_ligase.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(asp_trna_ligase.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(cys_trna_ligase.setInitialAmount(0),             'set initial amount for s1')
    ...
    glu_trna_amidotransferase = model.createSpecies()
    check(glu_trna_amidotransferase,                                 'create species s1')
    check(glu_trna_amidotransferase.setId('MG_462_MONOMER'),                     'set species s1 id')
    check(glu_trna_amidotransferase.setCompartment('c'),            'set species s1 compartment')
    check(glu_trna_amidotransferase.setConstant(False),              'set "constant" attribute on s1')
    check(glu_trna_amidotransferase.setInitialAmount(0),             'set initial amount for s1')
    check(glu_trna_amidotransferase.setSubstanceUnits('item'),       'set substance units for s1')
    check(glu_trna_amidotransferase.setBoundaryCondition(False),     'set "boundaryCondition" on s1')
    check(glu_trna_amidotransferase.setHasOnlySubstanceUnits(False), 'set "hasOnlySubstanceUnits" on s1')

    glu_trna_ligase = model.createSpecies()
    check(glu_trna_ligase,                                 'create species s1')
    check(glu_trna_ligase.setId('MG_295_DIMER'),                     'set species s1 id')
    ...
    check(glu_trna_ligase.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(gly_trna_ligase.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(his_trna_ligase.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(ile_trna_ligase.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(leu_trna_ligase.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(lys_trna_ligase.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(met_trna_ligase.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(met_trnaformyltrans.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(phe_trna_ligase.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(pro_trna_ligase.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(ser_trna_ligase.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(thr_trna_ligase.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(trp_trna_ligase.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(tyr_trna_ligase.setInitialAmount(0),             'set initial amount for s1')
    ...
    check(val_trna_ligase.setInitialAmount(0),             'set initial amount for s1')
    ...
    tmrna_ligase = model.createSpecies()
    check(tmrna_ligase,                                 'create species s1')
    check(tmrna_ligase.setId('MG_292_TETRAMER'),                     'set species s1 id')
    check(tmrna_ligase.setCompartment('c'),            'set species s1 compartment')
    check(tmrna_ligase.setConstant(False),              'set "constant" attribute on s1')
    check(tmrna_ligase.setInitialAmount(0),             'set initial amount for s1')
    check(tmrna_ligase.setSubstanceUnits('item'),       'set substance units for s1')
    check(tmrna_ligase.setBoundaryCondition(False),     'set "boundaryCondition" on s1')
    check(tmrna_ligase.setHasOnlySubstanceUnits(False), 'set "hasOnlySubstanceUnits" on s1')

    #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #
    # Create parameters and set the required attributes - MG471 tRNA aminoacylation (Alanine)
    #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #  #
    ...
    math_ast = sbml.parseL3Formula('k_mg471_aminoacylation * ALA * ATP')
    ...
    math_ast = sbml.parseL3Formula('k_mg472_aminoacylation * ILE * ATP ')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg475_aminoacylation * SER * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg479_aminoacylation * THR * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg483_aminoacylation * MG483 * CYS * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg484_aminoacylation * MG484 * PRO * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg485_aminoacylation * MG485 * MET * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg486_aminoacylation * MG486 * ILE * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg487_aminoacylation * MG487 * SER * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg488_aminoacylation * MG488 * MET * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg488_formyltransferase * met_aminoacylated_MG488 * H2O * FTHF10')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg489_aminoacylation * MG489 * ASP * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg490_aminoacylation * MG490 * PHE * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg492_aminoacylation * MG492 * ARG * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg493_aminoacylation * MG493 * GLY * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg495_aminoacylation * MG495 * ARG * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg496_aminoacylation * MG496 * TRP * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg497_aminoacylation * MG497 * ARG * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg499_aminoacylation * MG499 * GLY * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg500_aminoacylation * MG500 * LEU * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg501_aminoacylation * MG501 * LYS * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg502_aminoacylation * MG502 * GLU * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg502_amidotransferase * GLU_aminoacylated_MG502 * GLN * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg503_aminoacylation * MG503 * TYR * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg504_aminoacylation * MG504 * TRP * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg506_aminoacylation * MG506 * SER * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg507_aminoacylation * MG507 * SER * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg508_aminoacylation * MG508 * LEU * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg509_aminoacylation * MG509 * LYS * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg510_aminoacylation * MG510 * THR * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg511_aminoacylation * MG511 * VAL * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg512_aminoacylation * MG512 * THR * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg513_aminoacylation * MG513 * GLU * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg514_aminoacylation * MG514 * ASN * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg518_aminoacylation * MG518 * HIS * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg519_aminoacylation * MG519 * LEU * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg520_aminoacylation * MG520 * LEU * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg523_aminoacylation * MG523 * ARG * ATP')
    check(math_ast,                           'create AST for rate expression')
    ...
    math_ast = sbml.parseL3Formula('k_mg_0004_aminoacylation * MG_0004 * ALA * ATP')
    check(math_ast,                           'create AST for rate expression')
